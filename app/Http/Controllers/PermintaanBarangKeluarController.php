...
class PermintaanBarangKeluarController extends Controller
{
	...
	public function create()
	{
        ...
        $status_barang = DB::table('status_barang')->select('id', 'nama')->get();
        ...
        return view('permintaanbarangkeluar.create', compact('supplier','barang','status_barang','bm_kode_value'));
	}
	...
	public function store(Request $request): RedirectResponse
	{
		$request->validate([
			...
			'supplier_id.numeric' => 'ID supplier harus berupa angka.',
			'barang_id.required' => 'Barang harus dipilih.',
			'barang_id.numeric' => 'ID barang harus berupa angka.',
			'status_barang_id.required' => 'Status barang harus dipilih.',
			'status_barang_id.numeric' => 'ID status barang harus berupa angka.',
	...
	/*public function edit($id)
	{
		...
		return view('permintaanbarangkeluar.edit', compact('supplier', 'barang', 'data'));
	}
	...
	public function update($id, Request $request): RedirectResponse
	{
		...
		return redirect('/permintaanbarangkeluar')->with('success', 'Anda berhasil memperbarui data!');
	}
		*/
