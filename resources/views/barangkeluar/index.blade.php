...
@section('content')
    ...
    <div class="container mt-3" style="padding: 30px; padding-bottom: 13px;">
        <h4 class="mb-4" style="color: #8a8a8a;">Outbound Item</h4>
        <div class="search-container">
            <form action="{{ route('barangkeluar.index') }}" method="GET" class="search-box">
                    ...
                    <tbody>
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td>{{ $d->tanggal }}</td>
                                <td>
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#detailBarangModal"
    ...
    <!-- Modal Detail Barang -->
    <div class="modal fade" id="detailBarangModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><b class="text-dark">Penerima:</b></p>
                    <p><b class="text-dark">Keperluan:</b></p>
                    <p><b class="text-dark">Tanggal:</b></p>
                    <p><b class="text-dark">Keterangan:</b></p>
                    <p><b class="text-dark">Jumlah:</b></p>
                    <span class="sidebar-divider lg"></span>
                    <p><b class="text-dark">Barang / SN</b></p>
                    <p><b class="text-dark">Jenis Barang</b></p>
                    <p><b class="text-dark">Supplier</b></p>
                    <span class="sidebar-divider lg"></span>
                    <p><b class="text-dark">Barang / SN</b></p>
                    <p><b class="text-dark">Jenis Barang</b></p>
                    <p><b class="text-dark">Supplier</b></p>
                ...
                button.addEventListener('click', function() {
                    ...
                    fetch(`/barang/detail/${itemId}`)
                        ...
                        .then(data => {
                            ...
                            document.getElementById('detail-keterangan').textContent = data
                                .keterangan;
                        })
