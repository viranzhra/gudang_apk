...
@section('content')
    ...
    <div class="container mt-3" style="padding: 40px; padding-bottom: 15px; padding-top: 10px; width: 1160px;">
        ...
        <h4 class="mt-3" style="color: #8a8a8a;">Item Data</h4>
        ...
        {{-- Table --}}
        @can('item.view')
            <table id="barang-table" class="table table-bordered table-striped table-hover" width="100%"
                ...
                $('#tambahForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            'Berhasil menambahkan data!'); //response.message
                ...
                if (selected.length > 0) {
                    ...
                    $('#deleteForm').off('submit').on('submit', function(e) {
                        ...
                        fetch('/barang/delete-selected', {
                            ...
                            if (response.ok) {
                                showNotification('success', 'Selected items deleted successfully!');
                                $('#barang-table').DataTable().ajax.reload();
                            } else {
