    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form class="" method="post" action="/jenisbarang/update/{{ $data->id }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    @endif
                      ...
                      <div class="mb-5">
                        <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Jenis Barang</label>
