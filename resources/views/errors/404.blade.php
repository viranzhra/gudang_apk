...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;color:black">404 Not Found!</div>
    <div class="onlyforchrome" style="margin-top:5px;text-align:center;color:#4d4d4d;margin-top:20px;margin-bottom:80px; font-size:20px;line-height:1.2em;font-family: Georgia;">Press "Space" to jump your Dino and start the game.</div>
