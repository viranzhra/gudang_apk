<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center gap-x-5">
            <form action="{{ route('serialnumber.index') }}" method="GET" class="flex items-center max-w-sm mx-auto">   
            ...
            <a href="{{ route('serialnumber.create') }}" class="text-white bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-2xl text-sm w-full sm:w-auto py-2 px-3 text-center">Tambah Data</a>
                            ...
                            @foreach ($data as $d)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <th scope="row"
                                        ...
                                        <div class="ps-0">
                                            <div class="text-base font-semibold">{{ $d->serial_number }}</div>
                                        </div>
                                    </th>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 flex gap-x-2">
                                        ...
                                        <a href="/serialnumber/delete/{{ $d->id }}"
                        ...
                        document.getElementById('delete-selected').addEventListener('click', function() {
                            ...
                            if (selected.length > 0) {
                                if (confirm('Apakah Anda yakin ingin menghapus data yang dipilih?')) {
                                    fetch('/serialnumber/delete-selected', {
                                        method: 'POST',
                                        headers: {
